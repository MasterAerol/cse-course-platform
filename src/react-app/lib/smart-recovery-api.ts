...
export const smartRecoveryDashboardResponseSchema = z.object({
  ...
  data: z.object({
    ...
    prioritySkillCount: z.number().int().nonnegative(),
    ...
    selectedRecoverySkillCount: z.number().int().nonnegative().max(5),
    ...
    recoveryDiagnostics: z.object({
      statusCounts: z.object({
        not_enough_data: z.number().int().nonnegative(),
        needs_more_practice: z.number().int().nonnegative(),
        improving: z.number().int().nonnegative(),
        strong: z.number().int().nonnegative(),
        neutral: z.literal(0),
      }),
      generatableSkillCount: z.number().int().nonnegative(),
      selectedSkillCount: z.number().int().nonnegative().max(5),
      excludedSkillCount: z.number().int().nonnegative(),
      ambiguousEvidenceCount: z.number().int().nonnegative(),
      missingCanonicalSkillEvidenceCount: z.number().int().nonnegative(),
      missingGeneratorEligibilityCount: z.number().int().nonnegative(),
      invalidMappingOrContextEvidenceCount: z.number().int().nonnegative(),
    }),
