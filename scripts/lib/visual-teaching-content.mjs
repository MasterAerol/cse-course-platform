...
export const percentageGuidedTeachingContent = {
  title: 'Find 20% of 80',
  subtitle: 'Work with a guided mentor across each transformation.',
  prompt: 'Follow the highlighted focus at each step and then continue.',
  guide: {
    name: 'Instructor Maya',
    message: 'I will walk you through each move one at a time.',
  },
  steps: [
    {
      id: 'percent-step-1',
      ...
      boardExpression: '20%',
      guideMessage: 'We begin with the full percent statement.',
      explanation: 'This is the number we need to multiply against 80, but percent must be converted first.',
      focusLabel: 'Given value',
      emphasis: 'important',
    },
    {
      id: 'percent-step-2',
      stepNumber: 2,
      title: 'Remove the percent sign',
      boardExpression: '20',
      explanation: 'Percent tells us a value per 100. We temporarily keep the number and handle the divisor with the decimal.',
      focusLabel: 'Keep the number',
    },
    {
      id: 'percent-step-3',
      stepNumber: 3,
      title: 'Add the decimal place',
      boardExpression: '20.',
      explanation: 'Any whole number is the same as that number with a hidden decimal at the end.',
      focusLabel: 'Hidden decimal',
    },
    {
      id: 'percent-step-4',
      stepNumber: 4,
      title: 'Move decimal left',
      boardExpression: '0.20',
      guideMessage: 'Shift one left, then one more.',
      explanation: 'Dividing by 100 moves the decimal two positions to the left.',
      focusLabel: 'Final decimal form',
      emphasis: 'important',
    },
    {
      id: 'percent-step-5',
      stepNumber: 5,
      title: 'Interpret "of" as multiply',
      boardExpression: '0.20 × 80',
      explanation: 'The word "of" in percentage questions means multiply the decimal by the base amount.',
      focusLabel: 'Set up multiplication',
    },
    {
      id: 'percent-step-6',
      stepNumber: 6,
      title: 'Compute and finish',
      boardExpression: '20% of 80 = 16',
      explanation: '0.20 × 80 gives 16, so 20% of 80 is 16.',
      focusLabel: 'Final answer',
      emphasis: 'final',
    },
  ],
  visual: percentageOfVisual,
  memoryTip: {
    title: 'Memory anchor',
    text: 'Percent -> decimal move: remove %, add decimal at right end, then move it two steps left.',
  },
  commonMistake: {
    title: 'Common mistake',
    text: 'Forgetting that percent means per hundred, which usually means a two-place decimal shift.',
  },
}
