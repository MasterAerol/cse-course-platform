...
describe('General Information responsive contracts at 320–430px and 1024–1920px',()=>{
  it('keeps long legal and public-service text inside the independent desktop lesson shell',()=>{
  ...
  it('preserves mobile wrapping, drawer access, contained boards, targets, and focus',()=>{
